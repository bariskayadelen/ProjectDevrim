...
from  get_fuelprice_tr import fuel_company, fuel_district, fuel_price, diesel_price, lpg_price
import sqlite3
...
def main():
    FuelTr_update(today,fuel_company,fuel_district,fuel_price,diesel_price,lpg_price)
